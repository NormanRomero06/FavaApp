 ...
 * Use the [InformeInventarioFragment.newInstance] factory method to
...
class InformeInventarioFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment InformeInventarioFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            InformeInventarioFragment().apply {
